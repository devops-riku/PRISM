...
from app.features.rendering.presentation.quotation import (
    LEFT,
    _cell,
    _clean,
    _investment_section,
...
from app.features.documents.domain.template import KNOWN as KNOWN_HEADINGS
from app.features.documents.domain.template import resolve as resolve_sections
from app.features.quotations.domain.models import Estimate, ProposalDocument
