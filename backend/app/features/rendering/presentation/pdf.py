...
from app.features.documents.domain.design import font_for, resolve as resolve_design
from app.features.rendering.presentation.pdffonts import chosen as resolve_chosen, resolve as resolve_fonts
...
from .quotation import quotation_reference
