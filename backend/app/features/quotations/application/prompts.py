...
from app.features.quotations.domain.models import ProposalRequest
...
def build_brief(
    ...
    `kind` is a discipline id from the quotation domain's `kinds` module. It is
    last in the signature, and
