...
export default function ClientShell({ token }: ClientShellProps) {
  ...
  if (isDocument && view) {
    return (
      <div className="sheet-light page-glow min-h-dvh bg-canvas px-4 py-10 font-body text-body sm:px-6 sm:py-14">
  ...
  return (
    ...
    <div
      className={`sheet-light page-glow flex h-dvh items-center justify-center bg-canvas px-4 font-body text-body ${
